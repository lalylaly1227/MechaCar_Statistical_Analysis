...
mecha_mpg <- read.csv(file='/Users/gladys/Documents/GitHub/MechaCar_Statistical_Analysis/MechaCar_Statistical_Analysis/Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='/Users/gladys/Documents/GitHub/MechaCar_Statistical_Analysis/MechaCar_Statistical_Analysis/Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
